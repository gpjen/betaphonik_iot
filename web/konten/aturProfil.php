<?php 
	...
	$akun = mysqli_query($konekdb, "SELECT * FROM akun WHERE user='$email'");
                                ...
                                <div class="container" ><br><br><br><center>
                                    ...
                                    <div class="center">
                                        <div class="form-input">
                                            <h5 class=" font-weight-bold text-secondary">Gambar profil sekarang</h5>
                                            <div class="preview" >
                            ...
                            <div class="col-lg-6">
                                <div class="p-5"><br>
                                    <div class="text-center">
                                        <h4 class="m-0 font-weight-bold text-success"><?= $row['nama']; ?></h4><br>
                                    </div><br>
