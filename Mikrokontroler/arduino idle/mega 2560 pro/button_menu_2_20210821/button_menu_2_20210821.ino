...
void loop() {
  ...
  if ( now.hour() == W_cek1j) {
    ...
    if (PHmeter > phMax) {
      ...
      if (PHmeter >= 10) {
        pompaPHD = Out_pumpPhd * 4;
        pompaPHdown(pompaPHD);
      } else if (PHmeter >= 9) {
        pompaPHD = Out_pumpPhd * 3;
        pompaPHdown(pompaPHD);
      } else if (PHmeter >= 8) {
        pompaPHD = Out_pumpPhd * 2;
        pompaPHdown(pompaPHD);
      } else if (PHmeter >= 7) {
        pompaPHD = Out_pumpPhd;
        pompaPHdown(pompaPHD);
      } else if (PHmeter >= 6) {
        pompaPHD = Out_pumpPhd;
        pompaPHdown(pompaPHD);
...
tessensorA:
  ...
  lcd.setCursor(0, 2);
  lcd.print("       " + String(hitungjarak('A')) + " cm  ");
...
tessensorB:
  ...
  lcd.setCursor(0, 2);
  lcd.print("       " + String(hitungjarak('B')) + " cm  ");
...
tessensorC:
  ...
  lcd.setCursor(0, 2);
  lcd.print("       " + String(hitungjarak('C')) + " cm  ");
...
pumpA:
  if (digitalRead(TB) == 0) {
    ...
    while (digitalRead(TB) == 0) {
      Out_pumpA--;
      if (Out_pumpA <= 200) {
        Out_pumpA = 200; delay(150);
      }
      lcd.setCursor(0, 0); lcd.print(">PUMP A : " + String(Out_pumpA) + " /ms ");
    }
  } else if (digitalRead(TOK) == 0) {
    while (digitalRead(TOK) == 0) {}
  } else if (digitalRead(TN) == 0) {
  ...
  lcd.setCursor(0, 0);
  lcd.print(">PUMP A : " + String(Out_pumpA) + " /ms ");
  lcd.setCursor(0, 1);
  lcd.print(" PUMP B : " + String(Out_pumpB) + " /ms ");
  lcd.setCursor(0, 2);
  lcd.print(" PUMP PHD : " + String(Out_pumpPhd) + " /ms ");
  lcd.setCursor(0, 3);
  lcd.print(" [ SIMPAN ]");
...
pumpB:
  if (digitalRead(TB) == 0) {
    ...
    while (digitalRead(TB) == 0) {
      Out_pumpB--;
      if (Out_pumpB <= 200) {
        Out_pumpB = 200; delay(150);
      }
      lcd.setCursor(0, 1); lcd.print(">PUMP B : " + String(Out_pumpB) + " /ms ");
    }
  } else if (digitalRead(TOK) == 0) {
    while (digitalRead(TOK) == 0) {}
  } else if (digitalRead(TN) == 0) {
...
pumpPHdown:
  if (digitalRead(TB) == 0) {
    ...
    while (digitalRead(TB) == 0) {
      Out_pumpPhd--;
      if (Out_pumpPhd <= 200) {
        Out_pumpPhd = 200; delay(150);
      }
      lcd.setCursor(0, 2); lcd.print(">PUMP PHD : " + String(Out_pumpPhd) + " /ms ");
    }
  } else if (digitalRead(TOK) == 0) {
    while (digitalRead(TOK) == 0) {}
  } else if (digitalRead(TN) == 0) {
