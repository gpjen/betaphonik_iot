...
int ppmMin, ppmMax, Out_pumpA, Out_pumpB, Low_nutrisiA, Full_nutrisiA, Low_nutrisiB, Full_nutrisiB, Low_air, Full_air, PHmin, Out_pumpPhd;
float phMin, phMax;
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
